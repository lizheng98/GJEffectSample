...
public class Particle {
	...
	public boolean update(long miliseconds) {
		...
		mCurrentX = mInitialX + mSpeedX * (realMiliseconds / 10) + mAccelerationX * realMiliseconds * realMiliseconds;
		mCurrentY = mInitialY + mSpeedY * (realMiliseconds / 10) + mAccelerationY * realMiliseconds * realMiliseconds;
